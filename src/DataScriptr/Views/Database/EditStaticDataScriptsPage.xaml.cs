...
namespace DataScriptr.Views.Database
{
    /// <summary>
    ...
    public partial class EditStaticDataScriptsPage : Page
    {
        ...
        {
            //this.TableDataGrid.ItemsSource = ((DataScriptr.ViewModels.Database.EditStaticDataScriptsViewModel)this.DataContext).DataTable.DefaultView;
        }
